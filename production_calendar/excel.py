...
from production_calendar.dto import Week, Month, Quarter, Year

FILES_DIR = './production-calendar-files'
...
def _create_file(statistics, days, file_name):
    ...
    result_path = os.path.join(os.path.abspath(FILES_DIR), file_name)
    wb.save(result_path)
    return result_path
...
def create_file_week(week: Week):
    ...
    return _create_file(statistics, week.days, Week.FILE_NAME)
...
def create_file_month(month: Month):
    ...
    return _create_file(statistics, month.days, Month.FILE_NAME)
...
def create_file_quarter(quarter: Quarter):
    ...
    return _create_file(statistics, quarter.days, Quarter.FILE_NAME)
...
def create_file_year(year: Year):
    ...
    return _create_file(statistics, year.days, Year.FILE_NAME)
